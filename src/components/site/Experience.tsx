    ...
    <section id="experience" className="relative py-32">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="relative glass-strong rounded-3xl p-2 md:p-4">
          <div className="rounded-2xl bg-card/50 divide-y divide-border/60">
            {xp.map((e, i) => (
              <motion.div
                key={e.co + e.time}
                ...
                className="group grid md:grid-cols-12 gap-4 items-center px-6 py-7 hover:bg-foreground/[0.03] transition-colors"
              >
