      ...
      <div className="mx-auto max-w-[1240px] px-5 sm:px-8 grid md:grid-cols-12 gap-10 items-center">
        <div className="md:col-span-7">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-gradient-primary text-primary-foreground px-7 py-4 text-sm font-bold shadow-glow hover:opacity-95 transition"
            >
            ...
            <a
              ...
              download
              className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-7 py-4 text-sm font-bold text-foreground hover:bg-white/10 transition"
            >
              <FileDown className="h-4 w-4 text-accent" /> Download Profile
            </a>
          </div>
        </div>
        ...
        <div className="md:col-span-5 space-y-3">
          {[
            ...
            const Inner = (
              <div className="glass p-5 flex items-center gap-4 hover:border-accent/30 transition-all duration-300 group">
