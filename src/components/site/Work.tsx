    ...
    <section id="work" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
        <SectionHeader
          ...
          title="Case Studies &amp; Dashboards"
          intro="Deep dives into recent BI implementations, DAX optimization packages, dbt transformations, and customized predictive forecasting pipelines."
        />
        ...
        {!isLoading && projects.length === 0 && (
          <div className="glass rounded-3xl p-16 text-center max-w-xl mx-auto shadow-elegant">
            <p className="font-serif-display text-2xl mb-2 text-foreground">Deployments Pending</p>
            <p className="text-muted-foreground text-sm">
              We are finalizing architectural descriptions for recent dashboard setups. Please check back.
            </p>
          </div>
        )}
            ...
            >
              ...
              >
                ...
                <div className="lg:col-span-7 relative overflow-hidden rounded-2xl border border-white/5 bg-secondary/20 shadow-elegant group-hover:border-accent/25 transition-colors duration-500">
                  <div className="absolute inset-0 bg-gradient-to-t from-[#070b19]/60 to-transparent z-10" />
                  ...
                  {p.impact && (
                    <div className="mt-6 p-4 rounded-xl bg-white/[0.02] border border-white/5 flex items-center gap-3">
                      ...
                      <div className="text-xs">
                        <span className="text-muted-foreground uppercase font-mono tracking-widest block text-[9px] mb-0.5">Measurable Impact</span>
