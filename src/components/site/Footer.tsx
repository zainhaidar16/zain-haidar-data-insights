...
export function Footer() {
  return (
    <footer className="mt-32 border-t border-white/5 bg-[#070b19]/30 relative overflow-hidden">
      <div className="mx-auto max-w-[1240px] px-5 sm:px-8 py-16 grid gap-12 md:grid-cols-12 relative z-10">
        ...
        <div className="md:col-span-5 space-y-4">
          ...
          <p className="text-muted-foreground max-w-sm text-[14px] leading-relaxed">
            Data Analyst and BI Engineer based in Vienna. Crafting governed dashboard systems, complex analytical metrics, and ingestion warehouses that non-technical leaders can confidently defend in strategic planning sessions.
          </p>
        ...
        <div className="md:col-span-3">
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li><Link to="/about" className="text-muted-foreground hover:text-foreground transition-colors">Capabilities</Link></li>
        ...
        <div className="md:col-span-4 space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Scoping queries and custom consulting scoping requests processed within 24 hours.
          </p>
        </div>
      </div>
      ...
      <div className="border-t border-white/5">
        <div className="mx-auto max-w-[1240px] px-5 sm:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground font-mono">
          <div>© {new Date().getFullYear()} Zain Haidar. All rights reserved.</div>
