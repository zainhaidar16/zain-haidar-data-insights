...
export function PageHero({
  ...
  if (variant === "landing") {
    return (
      <section
        id="hero"
        className="nvr-home-hero relative overflow-hidden border-b border-[var(--line-soft)] bg-[var(--site-bg)] px-6 pt-32 pb-20 text-[var(--text-main)] md:pt-40 md:pb-24"
      >
        {decorative}
        ...
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="mb-6 text-5xl font-bold leading-[1.02] tracking-normal text-[var(--text-main)] sm:text-6xl md:text-7xl lg:text-[5rem]"
          >
            {title}
          </motion.h1>
          ...
          <motion.div
            ...
            className="mx-auto max-w-[60ch] text-lg font-normal leading-8 text-[var(--text-soft)] md:text-xl"
          >
            {description}
          </motion.div>
