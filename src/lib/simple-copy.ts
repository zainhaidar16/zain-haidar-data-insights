...
const simpleProjectsMap: Record<string, Omit<SimpleProject, "slug" | "cover_url">> = {
  "executive-kpi-retail": {
    ...
    impact:
      "Saved managers 4 hours of work every week and made it easy to see profits in real-time.",
    problem:
      "Store managers had to copy and paste numbers from 6 different spreadsheets every single week. It took a long time, and it was very hard to see if the stores were actually making a profit.",
    approach: [
  ...
  "patient-demand-forecasting": {
    ...
    problem:
      "Hospitals were having a hard time scheduling the right number of doctors and nurses. Some days they had too many staff sitting around, and other days they were short-staffed and patients had to wait.",
    approach: [
  ...
  "lakehouse-modernization": {
    ...
    problem:
      "A financial company's databases were extremely slow and took over 8 hours to update. This meant their daily business reports were always late, and the system broke constantly.",
    approach: [
  ...
  "cohort-retention-ltv": {
    ...
    problem:
      "Different departments in a software company couldn't agree on how to count lost customers. Their charts lived in messy spreadsheets that nobody trusted.",
    approach: [
