  ...
  return (
    <div className="space-y-6 font-poppins text-slate-800">
        ...
        <div className="flex-1 flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-xs rounded-xl bg-slate-50 border border-slate-200 focus:outline-none focus:border-blue-600 focus:bg-[#FFFFFF] transition"
            />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 bg-[#FFFFFF] border border-slate-200/60 rounded-3xl overflow-hidden shadow-sm">
          {loading ? (
                  ...
                  {filteredLeads.map((lead) => (
                    ...
                    >
                      <td className="px-5 py-3.5">
                        ...
                        <div className="text-xs text-slate-400 font-mono mt-0.5">{lead.email}</div>
                      ...
                      <td className="px-5 py-3.5">
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded-full border text-xs font-bold uppercase tracking-wide ${statusColors[lead.status] || "bg-slate-100 border-slate-200"}`}
                        >
                          {lead.status}
                        </span>
                      </td>
        ...
        <div className="lg:col-span-5 bg-[#FFFFFF] border border-slate-200/60 shadow-sm rounded-3xl overflow-hidden p-6 min-h-[350px] flex flex-col justify-between">
          {activeLead ? (
            <div className="space-y-6 flex-1 flex flex-col justify-between">
              <div className="space-y-5">
                ...
                <div className="flex justify-between items-start border-b border-slate-100 pb-4">
                  ...
                  <span
                    className={`inline-flex px-2.5 py-0.5 rounded-full border text-xs font-bold uppercase tracking-wider ${statusColors[activeLead.status]}`}
                  >
                    {activeLead.status}
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-xs font-semibold">
                  {activeLead.company && (
                    <div className="bg-slate-50 border border-slate-100 p-2.5 rounded-xl">
                      <span className="text-xs uppercase font-bold text-slate-400 tracking-wider block mb-0.5">
                        Company
                      </span>
                ...
                <div className="bg-slate-50 border border-slate-150/40 p-4.5 rounded-2xl">
                  <div className="flex items-center gap-1 text-xs uppercase font-bold text-slate-400 tracking-wider mb-2">
