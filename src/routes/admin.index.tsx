      ...
      <div className="space-y-8 animate-fade-in font-poppins">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {Array.from({ length: 7 }).map((_, idx) => (
            <div 
              key={idx} 
              className="bg-white border border-slate-200/65 shadow-xs rounded-2xl p-5 flex flex-col justify-between h-32 animate-pulse"
            >
        ...
        <div className="bg-white border border-slate-200/60 rounded-3xl p-6 space-y-4 animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {metrics.map((m) => {
          ...
          return (
            <div 
              key={m.label} 
              className="bg-white border border-slate-200/60 shadow-xs rounded-2xl p-5 hover:shadow-md transition duration-200 flex flex-col justify-between"
            >
              <div className="flex justify-between items-start">
                <div>
