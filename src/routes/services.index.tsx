      ...
      <section className="pt-32 md:pt-40 pb-20 bg-[#FAFAFA] relative overflow-hidden hero-arc">
        ...
        <div className="section-container">
          <div className="max-w-3xl">
            <p className="text-[12px] font-semibold uppercase tracking-widest text-[#71717A] mb-3">Tailored Solutions</p>
        ...
        <div className="mx-auto max-w-[1100px] px-5 sm:px-8 space-y-12">
          ...
          {loading && (
            <div className="flex flex-col justify-center items-center py-24 gap-3">
              ...
              <span className="text-xs text-[#71717A] font-medium">Loading services catalog...</span>
            </div>
          )}
          ...
          {!loading && !error && services.length === 0 && (
            <div className="border border-[#E4E4E7] rounded-3xl p-16 text-center bg-white max-w-2xl mx-auto">
              ...
              <p className="text-[#71717A] text-xs max-w-md mx-auto">No services are currently published.</p>
            </div>
          )}
          ...
          <div className="bg-[#09090B] rounded-3xl p-8 sm:p-12 flex flex-col sm:flex-row justify-between items-center gap-6">
            <div className="space-y-2 text-center sm:text-left">
              ...
              <p className="text-[#A1A1AA] text-[13px]">Let's discuss how we can build automated, secure reporting infrastructure tailored to your parameters.</p>
            </div>
