...
export const Route = createFileRoute("/projects/")({
  ...
  head: () =>
    pageHead(
      "Projects",
      "Explore Power BI reports, SQL analysis, Python workflows, and machine learning studies.",
      "/projects",
    ),
  component: Projects,
});
    ...
    <>
      ...
      <main id="main-content" tabIndex={-1}>
        <PageHero
          ...
          title="The work behind the skills."
          description="Explore the question, approach, findings, and limitations of each study. Open the reports and code to see how the work comes together."
        />
