        ...
        <div className="w-full max-w-md mx-auto px-6">
          <div className="glass-strong gradient-border rounded-3xl p-8">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Sign in to access the studio admin.
            </p>

            <button
              onClick={onGoogle}
              className="w-full mb-4 rounded-xl border border-border bg-foreground/[0.04] hover:bg-foreground/[0.08] py-3 text-sm font-medium transition"
            >
